...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now house-varsace-button text-uppercase ">add to cart</button>
      <button id="details-btn" class=" house-varsace-button text-uppercase ">Details</button></div>
      `;
